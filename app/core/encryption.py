...
class EncryptionService:
    ...
    def __init__(self, encryption_key: str) -> None:
        ...
        try:
            ...
            raise ValueError(
                "A chave de criptografia fornecida é inválida."
            ) from error
    ...
    def encrypt(self, content: bytes) -> bytes:
        ...
        if not content:
            raise ValueError(
                "O conteúdo para criptografia não pode estar vazio."
            )
    ...
    def decrypt(self, encrypted_content: bytes) -> bytes:
        """Descriptografa um conteúdo e verifica sua integridade."""

        if not encrypted_content:
            raise ValueError(
                "O conteúdo criptografado não pode estar vazio."
            )
